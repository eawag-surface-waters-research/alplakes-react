  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div className="text-width models">
          <div className="content">
            ...
            <div ref={this.divRefs["threed"]} id="threed" className="section">
              ...
              <div className="nonclickbox">
                <p>
                  ...
                  solving complex systems of differentioal equations for
                  momentum (Reynolds averaged Navier-Stokes equations), water
                  volume (continuity equation) and scalars such as temperature
                  or salinity (transport equation). The model accounts for
                  external forces including meteorological forcing and water
                  inflows and returns information regarding the water currents,
                  temperature and density dynamics. Processes occurring at
                  scales smaller than the grid size are typically parameterized
                  with so called turbulence closure models.
                </p>
                <p>
                ...
                <p>
                  ...
                  of temperature difference and the root mean square deviation
                  of simulated Schmidt stability. The calibrated parameters are:
                </p>
                <ul>
                ...
                <p>
                  ...
                  <NavLink to="/downloads">Downloads</NavLink> page for users
                  that want to adapt the models to their own purposes. These
                  files can also be generated using the code available{" "}
                  <a
                ...
                <p>
                  ...
                  . For users familiar with docker you can access documentation
                  on using custom Eawag compilations of D3D{" "}
                  <a
                ...
                <p>
                  ...
                  . For users familiar with docker you can access documentation
                  on using custom Eawag compilations of MITgcm{" "}
                  <a
                    href="https://github.com/eawag-surface-waters-research/docker"
                    target="_blank"
                    rel="noreferrer"
            ...
            <div ref={this.divRefs["oned"]} id="oned" className="section">
              ...
              <div className="nonclickbox">
                <p>
                  1D lake models simplify lake processes by representing the
                  lake as a single vertical column, divided into layers from the
                  ...
                  computationally intensive, 1D models are efficient for
                  long-term studies and are especially useful for deep lakes
                  where vertical changes are more significant than horizontal
                  ones.
                </p>
                <p>
                ...
                <p>
                  ...
                  square error (RMSE) of temperature difference between the
                  model and insitu temperature profiles. The calibrated
                  parameters are:
                </p>
                <ul>
                  <li>
                ...
                <p>
                  ...
                  . Please note users outside of Eawag will need to update the
                  weather data collection functions as we are not permitted to
                  distribute weather data. Full files are currently only
                  availble to project members but will become public after April
                  2025 when MeteoSwiss moves to an Open Data model.
                </p>
                <h3>Running the model</h3>
                <h4>Simstrat</h4>
                <p>
            ...
            >
              ...
              <div className="nonclickbox">
                ...
                <p>
                  Below is a list of all the remote sensing products available
                  on the Alplakes platform.
                </p>
                <SortableTable
                  data={remote_sensing}
                  language={language}
                ...
                <p>
                  ...
                  (2020). Landsat 8-9 Operational Land Imager / Thermal Infrared
                  Sensor Level-2, Collection 2 [dataset]. U.S. Geological
                  Survey.{" "}

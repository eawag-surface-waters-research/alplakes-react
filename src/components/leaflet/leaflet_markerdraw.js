...
L.Control.MarkerDraw = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    // Create an SVG icon
    var svgIcon =
      '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" style="margin: 6px;" version="1.1" viewBox="0 0 27.411 39.394" > <g transform="translate(-166.395 -160.11)"> <path fill="#e5e5e5" fillOpacity="1" strokeWidth="0.265" d="M176.248 193.749c-5.649-8.895-8.483-13.663-9.1-15.31-.31-.828-.63-2.41-.714-3.516-.694-9.26 7.79-16.564 16.78-14.444 5.209 1.228 9.432 5.629 10.409 10.846.389 2.078.137 5.229-.568 7.114-.807 2.158-12.434 21.064-12.953 21.064-.11 0-1.843-2.59-3.854-5.754zm6.235-14.376c1.6-.726 2.332-1.444 3.075-3.02.772-1.638.799-3.306.078-4.896-1.103-2.432-2.848-3.552-5.534-3.552s-4.432 1.12-5.534 3.552a5.759 5.759 0 000 4.763c.725 1.6 1.444 2.332 3.02 3.075 1.637.772 3.305.798 4.895.078z" ></path> </g> </svg>';

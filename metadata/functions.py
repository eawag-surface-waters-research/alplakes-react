...
def satellite_layers(key, sd, srd, prevent_water_quality):
    ...
    if "sentinel3" in sd and "chla" in sd["sentinel3"] and not prevent_water_quality:
        ...
        layer["sources"][layer["source"]]["models"].append(
            {
                "model": "Sentinel3",
                "metadata": "/alplakes/metadata/sentinel3_dimark3/{}/chla.json".format(key)
            }
        )
        layers.append(layer)
    if (("sentinel3" in sd and "Zsd_lee" in sd["sentinel3"]) or ("sentinel2" in sd and "Z490" in sd["sentinel2"])) and not prevent_water_quality:
        ...
        if "sentinel3" in sd and "Zsd_lee" in sd["sentinel3"]:
            layer["sources"][layer["source"]]["models"].append(
                {
                    "model": "Sentinel3",
                    "metadata": "/alplakes/metadata/sentinel3_dimark3/{}/Zsd_lee.json".format(key)
                }
            )
    ...
    if (("sentinel3" in sd and "tsm_binding754" in sd["sentinel3"]) or ("sentinel2" in sd and "tsm_dogliotti665" in sd["sentinel2"])) and not prevent_water_quality:
        ...
        if "sentinel3" in sd and "tsm_binding754" in sd["sentinel3"]:
            layer["sources"][layer["source"]]["models"].append(
                {
                    "model": "Sentinel3",
                    "metadata": "/alplakes/metadata/sentinel3_dimark3/{}/tsm_binding754.json".format(key)
                }
            )
    ...
    if (("sentinel3" in sd and "forel_ule" in sd["sentinel3"]) or ("sentinel2" in sd and "forel_ule" in sd["sentinel2"])) and not prevent_water_quality:
        ...
        if "sentinel3" in sd and "forel_ule" in sd["sentinel3"]:
            layer["sources"][layer["source"]]["models"].append(
                {
                    "model": "Sentinel3",
                    "metadata": "/alplakes/metadata/sentinel3_dimark3/{}/forel_ule.json".format(key)
                }
            )
